proxI = function(SNR, L, t.rho, target_width = 0.2) {
  ...
  opt = optimize(lossFun, interval = log(c(10, 1000000)))
...
drawLines = function(Ls, Is, cols = rainbow(length(Is))){
...
plotIvsL = function(){
  ...
  plot(NA, NA, xlim = c(2, 10^3), ylim = c(10, 1100000), type = "n",
       xlab = "Trials", 
       ylab = "Individuals",
       main = "",
       log = "xy", axes = FALSE,
